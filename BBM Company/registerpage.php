                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        ...
                        <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                            ...
                            <button type="button" data-mdb-button-init data-mdb-ripple-init
                                class="btn btn-grad-vio btn-floating mx-1">
                        ...
                        <form action="register.php" method="post">
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2 mb-5">
                                <button type="submit" data-mdb-button-init data-mdb-ripple-init
                                    class="btn btn-grad-vio btn-lg"
                                    style="padding-left: 2.5rem; padding-right: 2.5rem;">Login</button>
                                <p class="small fw-bold mt-2 pt-1 mb-0">Already have an Account? <a
                                        href="loginpage.php" class="link-danger">Log-in</a></p>
                            </div>

                        </form>
                    </div>
                    <div class="col-md-9 col-lg-6 col-xl-5">
                        <img src="stckimg/delivery.png" class="img-fluid" alt="Sample image">
                    </div>
                </div>
            </div>
